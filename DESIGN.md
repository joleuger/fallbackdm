...
* **GDM (PAM):** [`daemon/gdm-session-worker.c`](https://github.com/GNOME/gdm/blob/main/daemon/gdm-session-worker.c) — Shows how the minimalist pam session is started via `gdm_session_worker_initialize_pam`.
